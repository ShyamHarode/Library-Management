...
function dashboard() {
  ...
  return (
    <div className=" bg-gray-100 min-h-screen">
      <header className="w-screen flex items-center h-20 px-6 sm:px-10 bg-white">
        {/* <a
          href="#"
      ...
      <div className="flex flex-col text-gray-800 sm:flex-row">
        <aside className="flex h-24 sm:w-96 sm:h-screen">
